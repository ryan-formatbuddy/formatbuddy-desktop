...
const CATEGORIES: PermissionCategory[] = [
  ...
  },
  {
    ...
    items: [
      {
        what: "점검 기록 / 정리 후보 무시 목록 / 모니터 설정 (테마/알림/익명 사용 통계 옵션)",
      ...
      {
        what: "30일 복구함 (정리 파일·앱 삭제 흔적·잠시 꺼둔 시작 항목)",
        why: "선택한 정리 파일, 앱 삭제 흔적, 잠시 꺼둔 시작 항목을 30일 안에 되돌릴 수 있게 하기 위해서요.",
        evidence: "포맷버디 복구함 안에 30일 동안 보관해요. 앱 삭제 흔적과 시작 항목도 30일 안에 되돌릴 수 있게 따로 보관해요."
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        what: "선택한 정리 항목을 30일 복구함으로 보내기",
        why: "사용자가 직접 체크한 파일·앱 삭제 흔적·시작 항목만 처리하고, 30일 동안 앱 안에서 되돌릴 수 있게 하기 위해서요.",
  ...
  },
  {
    ...
    items: [
      ...
      {
        what: "파일 몰래 정리",
        why: "정리는 항상 사용자 명시 선택 + 복구함 보관이 기본이에요.",
