...
function appLeftoverResultLines(result: CleanupExecuteResult): string[] {
  ...
  if (backupCount > 0) {
    lines.push(`앱 삭제 흔적/기본 앱 목록/실행 경로/앱 연결/우클릭 메뉴/서비스/시작 항목 백업 ${backupCount}개는 30일 안에 되돌릴 수 있어요.`);
  }
  if (startupCount > 0) {
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 13, opacity: 0.8 }}>
          폴더·바로가기와 시작 항목, 서비스, 앱 삭제 흔적과 기본 앱 목록, 앱 연결, 우클릭 메뉴 흔적은 30일 안에 되돌릴 수 있게 챙겨둘게요. 보호 경로나 점검 후 바뀐 항목은 자동으로 건드리지 않아요.
        </p>
        <ul style={{ fontSize: 12, opacity: 0.75, margin: "0 0 16px", paddingLeft: 18 }}>
          ...
          <li>앱 삭제 흔적/기본 앱 목록/실행 경로/앱 연결/우클릭 메뉴/서비스/시작 항목 백업 {confirm.backupCount}개는 30일 동안 되돌릴 수 있어요.</li>
