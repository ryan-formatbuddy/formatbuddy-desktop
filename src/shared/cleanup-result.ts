...
export function registryBackupKindLabel(entry: RegistryBackupKindSource): string {
  ...
  if (entry.backupKind === "app-display-cache-value") return "앱 표시 기록 백업";
  ...
  if (entry.backupKind === "com-inproc-server-key") return "앱 확장 연결 백업";
  if (entry.backupKind === "com-app-id-key") return "앱 실행 연결 정보 백업";
...
export function registryBackupRestoreButtonLabel(entry: RegistryBackupKindSource): string {
  ...
  if (entry.backupKind === "app-display-cache-value") return "앱 표시 기록 되돌리기";
  ...
  if (entry.backupKind === "com-inproc-server-key") return "앱 확장 연결 되돌리기";
  if (entry.backupKind === "com-app-id-key") return "앱 실행 연결 정보 되돌리기";
